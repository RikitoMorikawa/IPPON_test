...
import InquiryUpdate from "../Update";
import PropertyInquiryHistory from "../../Properties/InquiryHistory";
import dayjs from "dayjs";
import isYesterday from "dayjs/plugin/isYesterday";
import isToday from "dayjs/plugin/isToday";
import isSameOrAfter from "dayjs/plugin/isSameOrAfter";
import "../../Properties/InquiryUpdate/PropertiesInquiryUpdate.css";
import { useParams, useSearchParams } from "react-router";
import { fetchPropertyInquiryDetail } from "../../../store/propertiesInquiriesSlice";
import { useDispatch, useSelector } from "react-redux";
import { AppDispatch } from "../../../store";
import { CustomTabPanel } from "../../Properties/Update";
...
const UpdateTab = () => {
  ...
  const [value, setValue] = useState(tabFromUrl ? parseInt(tabFromUrl) : 0);
